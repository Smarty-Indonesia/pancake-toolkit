...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 200 39.25" }, props),
        React__default['default'].createElement("image", { height: "39.25", href: isDark ? '/images/logo/logo-spy-tulisan-white.svg' : '/images/logo/logo-spy-tulisan-blue.svg' })));
};
...
var BottomNav = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(StyledBottomNav, __assign({ justifyContent: "space-around" }, props), items.map(function (_a, index) {
            ...
            return (showOnMobile && hasItems ? (React__default['default'].createElement(DropdownMenu, { key: label, items: menuItems, isBottomNav: true, activeItem: activeSubItem, showItemsOnMobile: showItemsOnMobile, setMenuOpenByIndex: setMenuOpenByIndex, index: index },
                React__default['default'].createElement(Box, null,
                ...
                :
                    (React__default['default'].createElement(Box, null,
                        React__default['default'].createElement(NotificationDot, { show: !!statusColor, color: statusColor },
                            React__default['default'].createElement(BottomNavItem, { href: href, isActive: href === activeItem, label: label, iconName: icon, showItemsOnMobile: false })))));
        }))));
};
